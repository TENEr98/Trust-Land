        ...
        <div class="items-block">
          ...
          <div class="item">
            ...
            <div class="image-wrapper-shoe">
              <img src="../../assets/img/products/<?= $shoe['category'] . '/' . $shoe['product_image'] ?>" alt="shoes"
                class="img">
            </div>
            <p class="price">$<?= $shoe['price'] ?></p>
            <div class="add">
              <button class="btn-add" type="submit" name="add" onclick="add(this)">Buy</button>
        ...
        <div class="items-block">
          ...
          <div class="item">
            ...
            <div class="image-wrapper-jacket">
              <img src="../../assets/img/products/<?= $jacket['category'] . '/' . $jacket['product_image'] ?>"
                alt="<?= $jacket['product_name'] ?>" class="img">
            </div>
            <p class="price">$<?= $jacket['price'] ?></p>
            <div class="add">
              <button class="btn-add" type="submit" name="add" onclick="add(this)">Buy</button>
              <input type="hidden" name="product_id" value="<?= $jacket['product_id'] ?>">
            </div>
          </div>
          <?php endforeach; ?>
        </div>
        ...
        <div class="items-block">
          ...
          <div class="item">
            ...
            <div class="image-wrapper-tshirt">
              <img src="../../assets/img/products/<?= $tshirt['category'] . '/' . $tshirt['product_image'] ?>"
                alt="<?= $tshirt['product_name'] ?>" class="img">
            </div>
            <p class="price">$<?= $tshirt['price'] ?></p>
            <div class="add">
              <button class="btn-add" type="submit" name="add" onclick="add(this)">Buy</button>
              <input type="hidden" name="product_id" value="<?= $tshirt['product_id'] ?>">
            </div>
          </div>
          <?php endforeach; ?>
        </div>
...
<script>
const add = (el) => {
  const parent = el.closest('.add')
  const input = parent.querySelector('input')
  const product_id = input.value
  window.location.href = `/e-commerce/pages/basket?id=${product_id}`
}
</script>